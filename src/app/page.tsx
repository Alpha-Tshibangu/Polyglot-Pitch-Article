    ...
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <main className="max-w-screen-md mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <article className="prose dark:prose-invert lg:prose-lg mx-auto">
          ...
          <div id="revenue-breakdown-section" className="border-l-4 border-orange-500 pl-4 mt-12">
        ...
        <p className="mt-6">
          ...
          making inclusivity and seamless interaction accessible to everyone. Join me in breaking down language barriers and building language bridges.
        </p>
      </main>
